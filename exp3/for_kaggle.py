...
# 添加命令行参数
parser.add_argument("--model", type=str, required=True, choices=["lenet", "alexnet", "resnet"])
...
# 加载MNIST训练集图像
all_images = load_mnist_images('/kaggle/input/test-file/train-images.idx3-ubyte')

# 加载MNIST训练集标签
all_labels = load_mnist_labels('/kaggle/input/test-file/train-labels.idx1-ubyte')
# 划分训练集和验证集
...
if model == 'lenet' :
    ...
    test_images = load_mnist_images('/kaggle/input/test-file-2/t10k-images.idx3-ubyte')
    test_images = tf.expand_dims(test_images, axis=-1)
    test_labels = load_mnist_labels('/kaggle/input/test-file-2/t10k-labels.idx1-ubyte')
